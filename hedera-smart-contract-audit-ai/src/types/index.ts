...
export interface AuditOptions {
  ...
  checkCompliance?: string[]; // Array of compliance standards to check against
  deepAnalysis?: boolean; // Run more intensive analysis
}
...
export interface TokenizeResult {
  tokens: string[];
  lineMap: Map<number, number[]>; // Maps token indices to line numbers
}
