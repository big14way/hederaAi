...
class ClaudeAnalyzer {
    constructor() {
        ...
        logger_1.logger.info('Claude AI client initialized successfully');
    }
    /**
    ...
    async conductAnalysis(prompt) {
        try {
            const message = await this.anthropic.messages.create({
                ...
                max_tokens: 4000,
                temperature: 0.2,
                system: "You are a smart contract security expert. Provide analysis in JSON format.",
                messages: [{
                        role: 'user',
                        content: prompt
                    }]
            ...
            logger_1.logger.error('Error during Claude API call:', error);
...
//# sourceMappingURL=claude-analyzer.js.map